...
$ helm install my-release --namespace cert-manager --version v1.12.7 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.7/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.12.7` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.12.7` |
...
| `acmesolver.image.tag` | acmesolver image tag | `v1.12.7` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.12.7` |
